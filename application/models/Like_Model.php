<?php 
    class Like_Model extends CI_Model {
        ...
        function deleteAllOfUserLikes($userid) {
            $query = "DELETE FROM LIKES WHERE UserId = ?";
            return $this->db->query("DELETE FROM LIKES WHERE UserId = ?", array($userid));
        }
    }
?>