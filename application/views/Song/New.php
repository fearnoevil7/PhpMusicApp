...
<html lang="en">
    ...
    <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-9 col-lg-10 order-1 order-md-2 content" style="margin: 50px 0px 0px 214px;">
                    ...
                    <div class = "row">
                        ...
                        ?>
                            <div>
                                <h4 style="margin: 0px 0px 0px 350px;">Upload Song 
                                ...
                                <div style=" width: 450px; height: 300px; margin: 25px 0px 0px 232px;">
                                    <form action="create" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <span>Artist </span><input class="form-control" style="display: block; margin: 16px 0px 25px 0px;" type="text" name="Artist" />
                                        </div>
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="custom-file">
                                                <label class="custom-file-label" for="inputGroupFile01">Select Song to Upload </label><input type="file" name="song" style="display: block;" class="custom-file-input" id="inputGroupFile01" />
                                            </div>
                                        </div>
