...
<html lang="en">
    ...
    <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-9 col-lg-10 order-1 order-md-2 content" style="margin: 0px 0px 0px 213px; background-color: #f8f9fa;">
                    ...
                    <div class = "row">
                        ...
                        ?>
                            <div>
                                <h4 style="margin: 0px 0px 0px 350px;"><?= $current_song['Name'] ?>
                                ...
                                <h5 style="margin: 0px 0px 0px 350px; color: #6c757d;">
                                    <?= $current_song['Artist'] ?>
                                </h5>
                                <div style=" width: 450px; height: 300px; margin: 25px 0px 0px 286px;">
                                    <img src="/assets/images/musicicon.jpg" style="width: 270px; height: 187px; display: block;">
                                    <audio <?php echo 'src=' . $current_song['Url'] ?> controls ></audio>
                                    <?php
                                        if($current_song['isLiked'] == false){
                                    ?>
                                            <a style="display: block;" <?php echo "href = /like/create/" . $this->session->userdata('UserId') . "/" . $current_song['SongId'] ?> id="buttonAnimationLike" class="ButtonToggle"><i class="far fa-thumbs-up"></i></a>
                                    <?php
                                        }
                                        else
                                        {
                                    ?>
                                            <a style="display: block;" <?php echo "href = /dislike/" . $this->session->userdata('UserId') . "/" . $current_song['SongId'] ?> id="buttonAnimation" class="ButtonToggle"><i class="far fa-thumbs-down"></i></a>
                                    <?php
                                        }
                                        ?>
                                </div>
                    ...
                    <div style="margin: 0px 0px 0px 250px;">
                        <h1 style="color: #6c757d; margin: 0px 0px 0px 7px;">Leave a Comment <i style="margin: 0px 0px 0px 52px; color: #bebebe;" class="far fa-comment-alt"></i></h1>
                        <form <?php echo "action=/Message/Create/" . $this->session->userdata('UserId') . "/" . $current_song['SongId'] . "/" ?> method = POST >
                            <input type="hidden" name="MessageTypeBoolean" value="FALSE">
                                        ...
                                        <div class = waffles>
                                            <div style="width: 300px;">
                                                ...
                                                <span class = messagedate style="margin: 0px 0px 0px 7px;">
                                                    ...
                                                    // var_dump(number_format(json_decode($message['CreatedAt'])->Date->NumericalMonth));
                                                    // var_dump(number_format(date("m")));
                                                    // var_dump(date("m"));
                                                    // var_dump(json_decode($message['CreatedAt'])->Date->NumericalMonth);
                                                    // var_dump(json_decode($message['CreatedAt']));
                                                    ...
                                                    if(json_decode($message['CreatedAt'])->Date->Year == date("Y")){
                                                        if(json_decode($message['CreatedAt'])->Date->Year == date("Y") && json_decode($message['CreatedAt'])->Date->NumericalMonth == date("m")){
                                                            ...
                                                            {
                                                                // var_dump(json_decode($message['CreatedAt'])->Date->Day > 1);
                                                        ...
                                                        {
                                                            if(intval(number_format(date("m"))) - intval(number_format(json_decode($message['CreatedAt'])->Date->NumericalMonth)) > 1){
                                                                echo intval(number_format(date("m"))) - intval(number_format(json_decode($message['CreatedAt'])->Date->NumericalMonth)) . " months ago";
                                                            }
                                                            else
                                                            {
                                                                echo intval(number_format(date("m"))) - intval(number_format(json_decode($message['CreatedAt'])->Date->NumericalMonth)) . " month ago";
                                                            }
                                                        }
                                                    }
                                                    else
                                                    {
                                                        if((int)date("Y") - (int)json_decode($message['CreatedAt'])->Date->Year > 1){

                                                            echo number_format(date("Y")) - json_decode($message['CreatedAt'])->Date->Year . " years ago";
                                                            // var_dump(json_decode($message['CreatedAt'])->Date->Year);
                                                            // var_dump(number_format(date("Y")));
                                                            // var_dump(json_decode($message['CreatedAt'])->Date->NumericalMonth);
                                                            // var_dump(number_format(date("m")));
                                                            // var_dump("test");
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            // var_dump((int)json_decode($message['CreatedAt'])->Date->Year);
                                                            // var_dump((int)date("Y"));
                                                            // var_dump(json_decode($message['CreatedAt'])->Date->NumericalMonth);
                                                            // var_dump(number_format(date("m")));
                                                            // var_dump("test2");
                                                            $monthCounter = 0;
                                                            for ($t = (int)json_decode($message['CreatedAt'])->Date->Year; $t <= (int)date("Y"); $t ++){
                                                                // var_dump("test");
                                                                // var_dump((string)$t . "year");
                                                                for($v = 1; $v < 13; $v++){
                                                                    // var_dump("test");
                                                                    // var_dump((string)$v . "month");
                                                                    if($v >= (int)json_decode($message['CreatedAt'])->Date->NumericalMonth & $t != (int)date("Y")){
                                                                        $monthCounter += 1;
                                                                    } elseif($t == (int)date("Y") & $t <= (int)date("m")){
                                                                        $monthCounter += 1;
                                                                    }
                                                                }
                                                            }
                                                            echo (string)$monthCounter . " months ago";

                                                            // var_dump("Estimate is" . (string)$monthCounter . "months ago?");
                                            ...
                                            <div style="width: 700px;">
                                                <div class = dropdown style="display: inline-block; margin: 0px 52px 0px 0px;">
                                                    ...
                                                    <div class = dropdown-menu>
                                                        ...
                                                        <form class = dropdown-item <?php echo "action=comment/" . $message['UserId'] . "/" . $message['MessageId'] . "/" . $current_song['SongId'] ?> method=POST>
                                                            <img class=UserProfilePic2 src =<?= $user['loggedUser']['ProfilePicUrl']?> >
                                                            <textarea class=commenttextbox cols = 34 rows = 1 name = Content></textarea>
                                                            <input type="hidden" name="IsWallPostComment" value="FALSE">
                                                ...
                                                <div class="dropdown" style="display: inline-block; width: 480px;">
                                                    ...
                                                    <?php
                                                        for($z=0; $z<count($comments['allcomments']); $z++){
                                                            if($comments['allcomments'][$z]['MessageId'] == $message['MessageId']){
                                                    ?>
                                                                <div style="display: inline-block;">
                                                                    <img style="height: 43px; width: 43px; margin: 0px 25px 25px 0px;" <?php echo "src=" . $comments['allcomments'][$z]['PosterPicUrl'] ?> >
                                                                </div>
                                                                <div style="display: inline-block; width: 400px;">
                                                                    <a class = messagedate <?php echo "href = /user/show/" . $comments['allcomments'][$z]['PosterId']?>> <b> <?= $comments['allcomments'][$z]['PosterName'] ?> </b></a>
                                                                    <span class = messagedate style="margin: 0px 0px 0px 7px;">
                                                    <?php
                                                        ...
                                                        if(json_decode($comments['allcomments'][$z]['CreatedAt'])->Date->Year == date("Y") && json_decode($comments['allcomments'][$z]['CreatedAt'])->Date->NumericalMonth == date("m")){
                                                            if(json_decode($comments['allcomments'][$z]['CreatedAt'])->Date->Year == date("Y") && json_decode($comments['allcomments'][$z]['CreatedAt'])->Date->NumericalMonth == date("m") && json_decode($comments['allcomments'][$z]['CreatedAt'])->Date->Day == date("d")){
                                                                ...
                                                                if($hour > 12){
                                                                    ...
                                                                    {
                                                                        if(date("H") - json_decode($comments['allcomments'][$z]['CreatedAt'])->Time->Hour > 1){
                                                                            
                                                                            if(json_decode($comments['allcomments'][$z]['CreatedAt'])->Time->AMPM == "AM"){
                                                                                echo date("H") - json_decode($comments['allcomments'][$z]['CreatedAt'])->Time->Hour . " hours ago";
                                                                            }
                                                                            else
                                                                            {
                                                                                // echo $hour - json_decode($comments['allcomments'][$z]['CreatedAt'])->Time->Hour . " hours ago";
                                                                                // var_dump(json_decode($comments['allcomments'][$z]['CreatedAt'])->Time->Hour);
                                                                                // var_dump(json_decode($comments['allcomments'][$z]['CreatedAt'])->Time->AMPM);
                                                                                // var_dump(date("H"));
                                                                                // var_dump($hour);
                                                                        ...
                                                                        {
                                                                            echo date("H") - number_format(json_decode($comments['allcomments'][$z]['CreatedAt'])->Time->Hour) . " hour ago";
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                // if(json_decode($comments['allcomments'][$z]['CreatedAt'])->Date->Day > 1){
                                                                //     echo number_format(date("d")) - json_decode($comments['allcomments'][$z]['CreatedAt'])->Date->Day . " day ago";
                                                                // }
                                                                // else
                                                                // {
                                                    ...
                                                    {
                                                        if((int)date("Y") - (int)json_decode($comments['allcomments'][$z]['CreatedAt'])->Date->Year > 1){
                                                            echo number_format(date("Y")) - json_decode($comments['allcomments'][$z]['CreatedAt'])->Date->Year . " years ago";
                                                        }
                                                        else
                                                        {
                                                            // echo (int)date("Y") - (int)json_decode($comments['allcomments'][$z]['CreatedAt'])->Date->Year . " year ago";
                                                            $monthCounter2 = 0;
                                                            for ($e = (int)json_decode($comments['allcomments'][$z]['CreatedAt'])->Date->Year; $e <= (int)date("Y"); $e ++){
                                                                // var_dump("test");
                                                                // var_dump((string)$t . "year");
                                                                for($w = 1; $w < 13; $w++){
                                                                    // var_dump("test");
                                                                    // var_dump((string)$v . "month");
                                                                    if($w >= (int)json_decode($comments['allcomments'][$z]['CreatedAt'])->Date->NumericalMonth & $e != (int)date("Y")){
                                                                        $monthCounter2 += 1;
                                                                    } elseif($e == (int)date("Y") & $e <= (int)date("m")){
                                                                        $monthCounter2 += 1;
                                                                    }
                                                                }
                                                            }
                                                            echo (string)$monthCounter2 . " months ago";
                                                        }
                                                    }
        ...
        <!-- <audio src="/assets/uploads/02LiveFreecopy.m4a" controls></audio> -->
        <!-- Optional JavaScript -->
